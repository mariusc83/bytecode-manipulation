...
class ClassInstrumenter(private val runtimeClassPath: List<URL>) {
    ...
    private val cl = URLClassLoader(runtimeClassPath.toTypedArray())
    ...
    fun instrument(input: ByteArray): ByteArray {
        ...
        // Our InstrumentationVisitorWrapper wraps the ClassWriter to intercept and
        // change bytecode as class elements are being visited.
        val cv = InstrumentationVisitorWrapper(cw)
